...
# Aside: The name 'phirl' is an inside joke.  WHIRL was a softjoin
# system William wrote in the 1990's, standing for Word-base
# Heterogeneous Information Representation Language.  The
...
class Phirl(Planner):
    ...
    # a specialized reducer, used below, which will grab only the numeric component and sum it up
    ...
    # diagnostic output that's easier to read
